...
class TestHumannameparserAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = HumannameparserAPIClient(self.api_key)

    @patch('apiverve_humannameparser.apiClient.requests.get')
